...
class OrderItemReferenceTest extends TestCase
{
	...
	{
		$orderItemReference = new OrderItemReference('123', '345', 'Super věc', OrderItemType::PHYSICAL, 2);
	...
	{
		try {
			new OrderItemReference('123 123 123 123 123 123 123 123 123 123 123 123 123 123', '345', 'Super věc', OrderItemType::PHYSICAL, 2);
