...
class RequestFactoryTest extends TestCase
{
	...
	public function testCreateInitPayment(): void
	{
		...
		$this->requestFactory->createInitPayment('5547', PayOperation::PAYMENT, PayMethod::CARD, true, 'https://vasobchod.cz/gateway-return', HttpMethod::POST, $cart, $customer, null, 'some-base64-encoded-merchant-data', '123', Language::CZ, 1800, 1, 1);
	...
	{
		$this->requestFactory->createOneclickInitPayment('ef08b6e9f22345c', '5547123', '127.0.0.1', new Price(1789600, Currency::CZK), false, 'https://shop.example.com/return', HttpMethod::POST);
	...
	{
		$this->requestFactory->createPaymentButtonRequest('123456', '::1', new Price(12500, Currency::CZK), 'https://www.example.com/return', HttpMethod::GET, PaymentButtonBrand::CSOB, null, Language::EN);
	...
	{
		$this->requestFactory->createApplePayInitRequest('1234567', '127.0.0.1', new Price(1789600, Currency::CZK), true, [
				'paymentData' => [
					'version' => 'EC_v1',
					'data' => 'zDwclQ1....',
			...
			], 'https://shop.example.com/return', HttpMethod::POST);
	...
	{
		$this->requestFactory->createApplePayProcessRequest('ef08b6e9f22345c', new Fingerprint(new FingerprintBrowser('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', 'text/html,application/xhtml+xml,application/xml;', 'en', false, null, null, null, null, null, null)));
	...
	{
		$customer = new Customer('John', 'Doe', null, null, null, 'john@example.com', '+420601123456', null, null);
		$order = new Order(Currency::CZK, OrderDeliveryType::DELIVERY_CARRIER, OrderCarrierId::CZ_POST_OFFICE, '123456');
		$order->addItem('123', null, 'Thing', OrderItemType::PHYSICAL, 2, null, null, null, null, 50000, 100000, 12000, 24000, 21, null);
		$order->addAddress('John Doe', Country::CZE, 'Praha 8', 'Pernerova', '42', '186 00', AddressType::BILLING);

		$this->requestFactory->createMallPayInitRequest('1234567', $customer, $order, false, '127.0.0.1', HttpMethod::GET, 'https://www.example.com/return', null, null);
	...
	public function testCreateMMallPayLogisticsRequest(): void
	{
		...
		$this->requestFactory->createMallPayLogisticsRequest('ef08b6e9f22345c', LogisticsEvent::SENT, new DateTimeImmutable('2021-01-01'), $orderReference, null, '123456');
	...
	{
		$this->requestFactory->createGooglePayInitRequest('1234567', '127.0.0.1', new Price(1789600, Currency::CZK), true, [], 'https://www.example.com/return', HttpMethod::POST);
	...
	{
		$this->requestFactory->createGooglePayProcessRequest('ef08b6e9f22345c', new Fingerprint(null, new FingerprintSdk('198d0791-0025-4183-b9ae-900c88dd80e0', 'encrypted-data', 'encoded-public-key', 5, 'sdk-reference-number', '7f101033-df46-4f5c-9e96-9575c924e1e7')));
